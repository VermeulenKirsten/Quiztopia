    ...
    public partial class version3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    YourScore = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizzesScoreboards", x => new { x.QuizId, x.ScoreboardId });
                    table.ForeignKey(
                        name: "FK_QuizzesScoreboards_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizzesScoreboards_Scoreboards_ScoreboardId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizzesScoreboards_ScoreboardId",
                table: "QuizzesScoreboards",
                column: "ScoreboardId");
        }
